            ...
            <div class="d-flex flex-column  order-2 order-lg-1" style="background-color:white;opacity:0.85">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form action="/recaptcha" method="post" class="form w-100 " novalidate="novalidate"
                            id="kt_sign_in_form" data-kt-redirect-url="../../demo1/dist/index.html" action="#">
                            @csrf
                            <!--begin::Heading-->
                            <center>
                                <img alt="Logo" src="../media/logos/cheque.png" class="h-75px " />
                            </center>
                            <div class="text-center mb-6">

                                <h1 class="text-dark fw-bolder mb-3" style="font-size:40px">CHEQUE</h1>
                            ...
                            <center>
                                <div class="mb-11"> {!! NoCaptcha::renderJs() !!}{!! NoCaptcha::display() !!}
