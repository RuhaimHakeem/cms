...
<div id="kt_app_content" class="app-content flex-column-fluid col-8 col-sm-8  col-md-4 col-lg-4 col-xl-4 col-xxl-4">
 <!--   <button onclick="history.back()" class="btnback mx-5 mt-5"><i class="fa-solid fa-angles-left"
    ...
    <form class="form w-100 px-5 " action="/updatecheque3/{{$account->id}}" method="post" enctype="multipart/form-data">
    ...
    @if(Session::has('success'))
        ...
        <div class="fv-row mb-8">
           ...
           <input  type="text" placeholder="Account Holder Name" name="accountholdername" autocomplete="off"
                 class="form-control bg-transparent" value="{{$account->accountholdername}}" >
         ...
         <div class="fv-row mb-8">
           ...
           <input  type="text" placeholder="Account Holder Number" name="accountholdernumber" autocomplete="off"
                 class="form-control bg-transparent" value="{{$account->accountholdernumber}}" >
