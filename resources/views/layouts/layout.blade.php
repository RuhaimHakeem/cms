...
<head>
    <base href="">
    <title>CHEQUE | @yield('title_select')</title>
    <meta charset="utf-8" />
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                                    ...
                                    <div class="d-flex align-items-center">
                                        @if(isset($agent))
                                        <h3 style="color:white" class="mt-3">name</h3>
                                        @else
                                        <h3 style="color:white" class="mt-3">Dashboard</h3>
                                        @endif
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click"
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link @yield('add_select')"
                                                href="/dashboard">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link @yield('updateaddcheque_select')"
                                                href="/updatechequedata">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
